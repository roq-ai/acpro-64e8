  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience streamlined financial control with acpro - your ultimate solution for comprehensive accounts and financial management."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmaW5hbmNlfGVufDB8fHx8MTY5MzQ0OTk2Nnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience streamlined financial control with acpro - your ultimate solution for comprehensive accounts and financial management.`}
            </Text>
            <Box
